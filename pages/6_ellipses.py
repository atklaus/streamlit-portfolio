...
from projects.AreaOfEllipse import (Ellipse,  # Import your classes
                                    OverlapOfEllipses, Point)
...
For demonstration, the default example uses two concentric circles, where the overlapping area should approximate the value of π (Pi).
        """)
